...
// Fields is a map string interface to define field in the structured log
type Fields map[string]interface{}

// With allow us to define field in out structured logs
func (f Fields) With(k string, v interface{}) Fields {
	f[k] = v
	return f
}

// WithFields allow us to define field in out structured logs
